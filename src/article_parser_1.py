...
class WikiHandler(xml.sax.ContentHandler):
    def __init__(self,outputpath, aliases,redirects,disambiguations,human_disambiguations,geo_disambiguations,number_disambiguations,
                 given_names,surnames,filename2title,title2Id,links,articles,stubs,link_probs):
        self.tag = ""
        self.content = ''
        self.title = ''
        self.id = -1
    ...
    def processArticle(self):
        ...
        if text.lower().startswith('#redirect'):
            ...
            filename = file_directory + self.title.replace(" ", '_').replace('/', '_') + '.txt'
...
if (__name__ == "__main__"):
    ...
    Handler = WikiHandler(outputpath,aliases,redirects,disambiguations,human_disambiguations,geo_disambiguations,number_disambiguations,given_names,surnames,filename2title,title2Id,links,articles,stubs,link_probs)
